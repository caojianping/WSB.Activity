...
;
        ...
        public string Post(string url, byte[] postData)
        {
            ...
            request.ContentType = "application/octet-stream";// "application/x-www-form-urlencoded";
        ...
        {
            HttpWebRequest request = CreateRequest(url, "POST");
            request.ContentType = contentType;// "application/octet-stream";// "application/x-www-form-urlencoded";
            request.ContentLength = postData.Length;
            request.KeepAlive = true;
            PostData(request, postData);
            respHtml = encoding.GetString(GetData(request));
